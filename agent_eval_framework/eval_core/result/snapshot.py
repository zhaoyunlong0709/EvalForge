...
记录 Agent 模型版本、Judge 模型版本、外部 API 版本、种子，
用于评测结果的可复现性声明。
"""
...
class DependencySnapshotRecorder:
    ...
    def record(
        ...
        Args:
            ...
            reproducibility_config: global.yaml 的 reproducibility 段
            case_count: 本次评测的用例数
        """
        return {
            ...
            "seeds": {
                "agent_seed": reproducibility_config.get("agent_seed"),
                "judge_seed": reproducibility_config.get("judge_seed"),
            },
